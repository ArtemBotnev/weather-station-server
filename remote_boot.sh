...
remote_addr=192.168.1.85 # address of remote machine
remote_password=raspberry # password of remote machine user

remote_path=/home/${remote_name}/apps/weather_station/server # remote file path
